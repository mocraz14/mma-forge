...
export default function ConditioningScreen() {
  ...
  const cats = ['All', ...Array.from(new Set(conditioning.map(s => s.subcategory)))];
  const filtered = useMemo(() => conditioning.filter(t =>
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={{ padding: 16, paddingBottom: 0 }}>
        <Text style={styles.h1}>Conditioning</Text>
        <Text style={styles.sub}>Flexibility · S&C · Cardio</Text>
